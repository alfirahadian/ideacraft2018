...
?>
      <center><h5 style="color: #666">Update Data Participant 2</h5></center>
      <div class="container">
            <!-- PARTICIPANT 1 -->
            <div id="participant_1_2_3" class="row">
            <h5 style="color: #666">2nd Participant</h5><br>
                <table class="col-lg-12">
                <col style="width:20%" span="5" />
                  <?php echo form_open("marketition/update_participant_2_marketition"); ?>
                  <tr>
                    <td>Name:</td>
                      <?php 
                      if($bio2_name == ''){
                     ...
                     <td>
                      ...
                      <td>                  
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio2_name" name="bio2_name" value="<?php echo $bio2_name; ?>" />
                  ...
                  <tr>
                    <td>Mobile Phone Number:</td>
                     ...
                     <td>
                      ...
                      <td>
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio2_phone" name="bio2_phone" value="<?php echo $bio2_phone; ?>" />
                  ...
                  <tr>
                   ...
                   <?php 
                     ...
                     <td>
                      ...
                      <td>
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio2_major" name="bio2_major" value="<?php echo $bio2_major; ?>" />
                  ...
                  <tr>
                    ...
                    <td> 
                      <label>
                        <input type="checkbox" data-toggle="collapse" data-target="#collapseOne" name="bio2_tick" value="1"/>
                        <span></span>
                      </label>
                    </td>
                  </tr>
                    <tr id="collapseOne" class="panel-collapse collapse out">
                      <td><div>The company name (employees only):</div></td>
                        <td>
                         <div class="input-field col s12 l12">
                              <input style="color: #666;" type="text" id="bio2_company" name="bio2_company" value="<?php echo $bio2_company; ?>" />

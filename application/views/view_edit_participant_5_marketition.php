...
?>
      <center><h5 style="color: #666">Update Data Participant 5</h5></center>
      <div class="container">
            <!-- PARTICIPANT 1 -->
            <div id="participant_1_2_3" class="row">
            <h5 style="color: #666">5th Participant</h5><br>
                <table class="col-lg-12">
                <col style="width:20%" span="5" />
                  <?php echo form_open("marketition/update_participant_5_marketition"); ?>
                  <tr>
                    <td>Name:</td>
                      <?php 
                      if($bio5_name == ''){
                     ...
                     <td>
                      ...
                      <td>                  
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio5_name" name="bio5_name" value="<?php echo $bio5_name; ?>" />
                  ...
                  <tr>
                    <td>Phone Number:</td>
                     ...
                     <td>
                      ...
                      <td>
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio5_phone" name="bio5_phone" value="<?php echo $bio5_phone; ?>" />
                  ...
                  <tr>
                   ...
                   <?php 
                     ...
                     <td>
                      ...
                      <td>
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio5_major" name="bio5_major" value="<?php echo $bio5_major; ?>" />
                  ...
                  <tr>
                    ...
                    <td> 
                      <label>
                        <input type="checkbox" data-toggle="collapse" data-target="#collapseOne" name="bio5_tick" value="1"/>
                        <span></span>
                      </label>
                    </td>
                  </tr>
                    <tr id="collapseOne" class="panel-collapse collapse out">
                      <td><div>Company name (employees only):</div></td>
                        <td>
                         <div class="input-field col s12 l12">
                              <input style="color: #666;" type="text" id="bio5_company" name="bio5_company" value="<?php echo $bio5_company; ?>" />
                  ...
                  <tr>
                    ...
                    <?php 
                     ...
                     <td>
                      ...
                      <td>
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio5_address" name="bio5_address" value="<?php echo $bio5_address; ?>" />
                            <?php echo form_error('bio5_address', '<div class="error" style="color: red;">', '</div>'); ?>
                      </div>
                    </td>
                    <?php 
                        } 

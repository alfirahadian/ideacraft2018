...
?>
      <center><h5 style="color: #666">Update Data Participant 4</h5></center>
      <div class="container">
            <!-- PARTICIPANT 1 -->
            <div id="participant_1_2_3" class="row">
            <h5 style="color: #666">4th Participant</h5><br>
                <table class="col-lg-12">
                <col style="width:20%" span="5" />
                  <?php echo form_open("marketition/update_participant_4_marketition"); ?>
                  <tr>
                    <td>Name:</td>
                      <?php 
                      if($bio4_name == ''){
                     ...
                     <td>
                      ...
                      <td>                  
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio4_name" name="bio4_name" value="<?php echo $bio4_name; ?>" />
                  ...
                  <tr>
                    <td>Mobile Phone Number:</td>
                     ...
                     <td>
                      ...
                      <td>
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio4_phone" name="bio4_phone" value="<?php echo $bio4_phone; ?>" />
                  ...
                  <tr>
                   ...
                   <?php 
                     ...
                     <td>
                      ...
                      <td>
                       <div class="input-field col s12 l12">
                            <input style="color: #666;" type="text" id="bio4_major" name="bio4_major" value="<?php echo $bio4_major; ?>" />
                  ...
                  <tr>
                    ...
                    <td> 
                      <label>
                        <input type="checkbox" data-toggle="collapse" data-target="#collapseOne" name="bio4_tick" value="1"/>
                        <span></span>
                      </label>
                    </td>
                  </tr>
                    <tr id="collapseOne" class="panel-collapse collapse out">
                      <td><div>The company name (employees only):</div></td>
                        <td>
                         <div class="input-field col s12 l12">
                              <input style="color: #666;" type="text" id="bio4_company" name="bio4_company" value="<?php echo $bio4_company; ?>" />
